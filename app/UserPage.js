          ...
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-8 col-md-7
              ...
              <Switch>
                ...
                <Route exact path="/:user/followers" component={() => <Followers profile={this.state.profile} /> } />
                <Route exact path="/:user/following" component={() => <Followings profile={this.state.profile} /> } />
              </Switch>
            </div>
          </div>
        </div>
